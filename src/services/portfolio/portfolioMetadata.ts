...
const AAVE_METADATA: Record<string, PositionMetadata> = {
  aOptWstEth: {
    ...
    img: '/images/portfolio/wsteth-token.png',
  },
  aGnowstEth: {
  ...
  aBaseCbEth: {
    ...
    img: '/images/portfolio/cbeth-token.png',
  },
  aBaseCbBtc: {
    ...
    img: '/images/portfolio/cbbtc-token.png',
  },
  aOptWbtc: {
    name: 'Aave OP wBTC',
    ...
    img: '/images/portfolio/wbtc-token.png',
  },
};
...
export function getAaveMetadata(tokenName: string): PositionMetadata {
  return AAVE_METADATA[tokenName] || {
    ...
    img: '/images/portfolio/aave-token.png',
  };
}
